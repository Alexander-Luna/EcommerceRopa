        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formularioProveedor">
                    ...
                    <div class="form-group">
                        <label for="nombre" class="col-form-label">Color Hexadecimal:</label>
                        <input type="text" class="form-control" id="color_hexa" name="color_hexa" required>
                    </div>
                    <div class="form-group">
...
<script>
    $('#miModal').on('hidden.bs.modal', function() {
        ...
        document.getElementById("color_hexa").value = "";
