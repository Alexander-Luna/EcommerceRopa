document.addEventListener("DOMContentLoaded", async function () {
  ...
  $(document).on("click", ".btnEditar", function () {
    ...
    $("#miModal").modal("show");
    document.getElementById("title").innerText = "Editar Genero";
    $("#id").val(rowData.id);
  ...
  function insertar() {
    try {
      ...
      if (id === "") {
        fetch("../../controllers/router.php?op=insertGenero", {
          method: "POST",
          body: formData,
        })
          .then((response) => {
        ...
        fetch("../../controllers/router.php?op=updateGenero", {
          method: "POST",
          body: formData,
        })
          .then((response) => {
  ...
  function reloadSection() {
    try {
      fetch("../../controllers/router.php?op=getAllGeneros").then(
        (response) => {
          if (!response.ok) {
            throw new Error(
              "Hubo un problema al obtener los detalles del genero."
            );
          }
