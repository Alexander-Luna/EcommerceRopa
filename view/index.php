    ...
    <div class="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <a class="nav-link" href="index.php?modulo=editarUsuario&id=<?php echo $_SESSION['user_session']['user_id']; ?>">
            <i class="far fa-user"></i>
          </a>
          <a class="nav-link text-danger" href="index.php?modulo=&sesion=cerrar" title="Cerrar sesion">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
          ...
          <div class="user-index mt-3 pb-3 mb-3 d-flex">
            <div class="info">
              <a href="#" class="d-block"><?php echo $_SESSION['user_session']['nombre']; ?></a>
            </div>
          </div>
