            ...
            render: function (data, type, row) {
                if (row.imagen) {
                    return (
                        '<img src="' +
                        row.imagen +
                        '" alt="Imagen del Producto" style="max-width: 100px; max-height: 100px;"></img>'
                    );
                } else {
                    return '<img src="../../public/images/products/defaultprod.png" alt="Imagen del Producto" style="max-width: 100px; max-height: 100px;"></img>';
                }
            },
        },
        { data: "talla" },         // Talla
