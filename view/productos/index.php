                              ...
                              <thead>
                                ...
                                GROUP BY p.id, p.nombre, p.descripcion, p.precio, p.existencia, p.activo,  p.categoria, p.tipo, p.talla, p.colores;";
                                    ...
                                    <tr>
                                        ...
                                        <?php endif; ?>
                                        &nbsp;
                                        <a href="panel.php?modulo=editarp&id=<?php echo $row['id'] ?>" style="margin-right: 5px;"> <i class="btn btn-info btn-sm  fas fa-edit"></i> </a>
                                                    ...
                                                    <form action="agregar_producto.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                                ...
                                                                <label class="btn btn-secondary">
                                                                    <input type="radio" name="categoria" id="categoriaEstudiante" value="estudiante"> Estudiante
                                                                </label>
                                                                <label class="btn btn-secondary">
