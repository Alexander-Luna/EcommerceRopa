...
?>
	...
	<head>
		...
		<!-- <style>
		/* Estilo base para dispositivos de escritorio */
		.section-slide {
			height: 85vh;
			/* Altura del 80% de la ventana en escritorio */
		}
		...
		@media (max-width: 768px) {
			.section-slide {
				height: 25vh;
				/* Altura del 25% de la ventana en dispositivos móviles */
			}
		}
	</style> -->
	</head>
					...
					<div class="row">
						<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
							...
							<div class="block1 wrap-pic-w">
								<img src="categoriaimg/estudiantes.png" alt="IMG-BANNER" style="height:100px; weight:150px;">
